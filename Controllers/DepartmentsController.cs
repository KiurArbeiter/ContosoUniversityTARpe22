                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError(string.Empty, "The record that you have attempted to edit"
                            ...
                            + "The save button again. Otherwise click back to list hyperlink.");
        ...
        public async Task<IActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            if (concurrencyError.GetValueOrDefault())
            {
                ViewData["ConcurrencyErrorMessage"] = "The record you attempted to delete"
                    ...
                    + "The Delete operator was cancelled and the current values in the "
                    + "database have been displayed. If you still require to edit this record."
                    + "click the save button again. Otherwise click back to list hyperlink.";
            }
            return View(department);

            //var student = await _context.Departments
            //    .AsNoTracking()
